...
import UIKit
import Alamofire
class BFCCViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell : BarFCCCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: "FourChoices", for: indexPath) as! BarFCCCollectionViewCell
