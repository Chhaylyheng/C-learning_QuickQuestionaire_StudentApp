...
import UIKit
import Alamofire
class BThCCViewController: UIViewController, UICollectionViewDelegate,UICollectionViewDataSource {
...
//            getAwnserFromStudent()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell : QCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: "QuestioncmdCell", for: indexPath) as! QCollectionViewCell
