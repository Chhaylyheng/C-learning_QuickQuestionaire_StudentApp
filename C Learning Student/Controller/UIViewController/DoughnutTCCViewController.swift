//
//  DoughnutTCCViewController.swift
//  C Learning Teacher
//
...
import UIKit
import Alamofire
class DoughnutTCCViewController: UIViewController {
    ...
    private func setPieChart() -> PNPieChart {
        ...
        let noString = "\(noNum)"
        let item1 = PNPieChartDataItem(dateValue: CGFloat(yesPer), dateColor:  PNLightGreen, description: "Choince:1"+","+yesString)
        let item2 = PNPieChartDataItem(dateValue: CGFloat(noPer), dateColor: PNRed, description: "Choice:2"+","+noString)
